...
/**
 * The <code>ExceptionAttributes</code> interface defines the behavioral contract to be implemented by concrete
 * ExceptionAttributes classes. Provides attributes which describe Exceptions and the context in which they occurred.
 *
 * @author Bosko Mijin
